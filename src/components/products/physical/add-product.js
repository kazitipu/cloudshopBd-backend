                                        ...
                                        <button
                                          ...
                                          onClick={async () => {
                                            ...
                                            let categoryObj = {
                                              ...
                                              slug: this.state.categoryName.toLowerCase(),
                                              count: 0,
                                              parentCategory:
                                        ...
                                        <button
                                          ...
                                          onClick={async () => {
                                            ...
                                            let brandObj = {
                                              ...
                                              slug: this.state.brandName.toLowerCase(),
                                              count: 0,
                                              parentBrand:
                                                this.state.parentBrand,
                                              logo: "",
                                              banner: "",
                                            };

                                            await this.props.uploadBrandRedux(
                                              brandObj
                                            );
                                            toast.success(
                                              "Successfully added brand name."
                                            );
                                            this.setState({
                                              addBrand: !this.state.addBrand,
                                            });
