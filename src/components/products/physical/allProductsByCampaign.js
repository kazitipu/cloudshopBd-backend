...
class AllProductsByCampaign extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  componentDidMount = async () => {
    ...
    console.log(id);
    await this.props.getSingleCampaignProductsRedux(id);
    const campaign = await getSingleCampaign(id);
    this.setState({
      loading: false,
      campaign: campaign,
    });
  ...
  componentWillReceiveProps = async (nextProps) => {
    ...
    if (this.props.match.params.id !== nextProps.match.params.id) {
      await this.props.getSingleCampaignProductsRedux(
...
const mapStateToProps = (state) => {
  return {
    allProducts: state.products.campaignProducts,
