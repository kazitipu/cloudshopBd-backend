    ...
    return (
      <Fragment>
        {this.state.loader ? (
          ...
          >
            <ClipLoader loading={this.state.loader} size={30} color="#ec345b" />
          </div>
        ) : (
          <>
                          ...
                          <span
                            ...
                            onClick={() => {
                              this.props.history.push(
                                "/products/physical/categories-2/homescreen"
                              );
                            }}
                          >
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  ...
                                  categories.find(
                                    ...
                                    ? categories.find(
                                        (cat1) =>
                                          cat1.id == category.parentCategory
                                      ).name
                                    : ""}
                                </td>
                                <td>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {productObj ? "Update" : "Add New"} Category <br />
                      Id:{productObj && productObj.id}
                    </div>
                    <button
                      type="button"
                      className="close"
                        ...
                        <div className="form-group">
                          ...
                          >
                            ...
                            {this.state.type == "upload" ? (
                              <option
                                value={this.props.homeCategories.length + 1}
                              >
