  ...
  renderEditable = (cellInfo) => {
    ...
    if (myData.length > 0) {
      ...
      myData.forEach((expense, index) => {
        newData.push({
          date: expense.date,
          "Previous Cash": `${parseInt(expense.previousCash) + 500000}Tk`,
          "Total Cash In": `${expense.totalCashIns}Tk`,
          "Total Cash Out": `${expense.totalCashOuts}Tk`,
          "Remaining Cash": `${parseInt(expense.remainingBalance) + 500000}Tk`,
        });
      });
      return (
        <div
            ...
            <span
              ...
              onClick={() => {
                this.props.history.push(
                  `/bill-summary-by-day/${row.original.date.replaceAll(
                    "/",
                    "-"
                  )}`
                );
